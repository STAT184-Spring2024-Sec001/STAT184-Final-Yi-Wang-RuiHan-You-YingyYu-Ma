...
Based on the frequency table, we can see that the Hollywood market is very centralized, studios other than the Big Six only accounting for 25% of the total number. And for the big six movie studios, Warner Bros., again, has the highest number of wide release movie. But when we compare the number of wide release and total release, we see that Universal Pictures actually has the largest percentage, over 80%, which means that the majority of their films are widely released across the country.
